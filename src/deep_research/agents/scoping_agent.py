...
from deep_research.prompts.prompts import clarify_with_user_instructions, transform_messages_into_research_topic_prompt
from deep_research.states.state_scope import AgentInputState, AgentState, ClarifyWithUser, ResearchQuestion

def get_today_str() -> str:
    return datetime.now().strftime("%a %b %-d, %Y")


model = init_chat_model(model="openai:gpt-4.1", temperature=0.2)
